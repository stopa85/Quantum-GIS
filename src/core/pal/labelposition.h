...
class LabelPosition{
   ...
   friend bool pruneLabelPositionCallback (PointSet *feat, void *ctx);
   friend void setCost (int nblp, LabelPosition **lPos, int max_p, RTree<PointSet*, double, 2, double> *ftIndex, double bbx[4], double bby[4]);
...
private:
  ...
  double getCostFromPoint (double x, double y);
  double getCostFromLine (int n, double *x, double *y);
  double getCostFromPolygon (int n, double *x, double *y, double &dist_sq);
   ...
   */
  void setCostFromPolygon (RTree <PointSet*, double, 2, double> *ftIndex, double bbx[4], double bby[4]);
...
// TODO make a LabelPosition static function

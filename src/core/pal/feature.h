...
class Feature : public PointSet {
   ...
   friend bool pruneLabelPositionCallback (Feature *feat, void *ctx);
...
protected:
  ...
  /**
    ...
    */
   int setPosition(double scale, LabelPosition ***lPos, double bbox_min[2], double bbox_max[2], PointSet *mapShape
#ifdef _EXPORT_MAP_
   , std::ofstream &svgmap
#endif
   );

...
private:
   ...
   RTree<LabelPosition*, double, 2, double> *index;  // index all candidates
   RTree<LabelPosition*, double, 2, double> *index_sol; // index active candidates
   RTree<LabelPosition*, double, 2, double> *index_subsol; // idem for subparts

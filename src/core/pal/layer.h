...
public: 
    ...
    */
   void registerFeature (const char *geom_id, double label_x, double label_y, PalGeometry *userGeom);

   /**
    * \brief register a feature in the layer without label
    *
    * @param geom_id unique identifier
    * @param userGeom user's geometry that implements the PalGeometry interface
    *
    * @throws PalException::FeatureExists
    */
   void registerFeature (const char *geom_id, PalGeometry *userGeom);
   ...
   /**
    * \brief get unit of labels sizes
    */
   Units getUnit();
    ...
    * \brief set unit for label size
    *
    * Some strange stuff will occurs when the unit change, and you don't update the labels' sizes
    */

...
{
 public:
  QgsCentralPointPositionManager(QgsVectorLayer* vl);
  ~QgsCentralPointPositionManager();
  void findOptimalObjectPositions(const QgsRect& viewExtent, const QgsMapToPixel * cXf, const QgsCoordinateTransform* ct);

...
void QgsGrassEdit::init()
{
  ...
  mNewPointAction = new QAction(
    QIcon(":/grass/grass_new_point.png"), tr("New point"), this);
  ...
  mNewLineAction = new QAction(
    QIcon(":/grass/grass_new_line.png"), tr("New line"), this);
  ...
  mNewBoundaryAction = new QAction(
    QIcon(":/grass/grass_new_boundary.png"), tr("New boundary"), this);
  ...
  mNewCentroidAction = new QAction(
    QIcon(":/grass/grass_new_centroid.png"), tr("New centroid"), this);
  ...
  mMoveVertexAction = new QAction(
    QIcon(":/grass/grass_move_vertex.png"), tr("Move vertex"), this);
  ...
  mAddVertexAction = new QAction(
    QIcon(":/grass/grass_add_vertex.png"), tr("Add vertex"), this);
  ...
  mDeleteVertexAction = new QAction(
    QIcon(":/grass/grass_delete_vertex.png"), tr("Delete vertex"), this);
  ...
  mMoveLineAction = new QAction(
    QIcon(":/grass/grass_move_line.png"), tr("Move element"), this);
  ...
  mSplitLineAction = new QAction(
    QIcon(":/grass/grass_split_line.png"), tr("Split line"), this);
  ...
  mDeleteLineAction = new QAction(
    QIcon(":/grass/grass_delete_line.png"), tr("Delete element"), this);
  ...
  mEditAttributesAction = new QAction(
    QIcon(":/grass/grass_edit_attributes.png"), tr("Edit attributes"), this);
  ...
  mCloseEditAction = new QAction(
    QIcon(":/grass/grass_close_edit.png"), tr("Close"), this);

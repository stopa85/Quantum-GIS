...
class QgsVectorDataProvider : public QgsDataProvider
{
    ...
    public:
       ...
       */
      virtual long updateFeatureCount(size_t dataSourceLayerNum = 0)
      {
        return -1;
      }
       ...
       * @return  QgsFeature
       */
      virtual QgsFeature * getFeatureAtId(int featureId, size_t dataSourceLayerNum = 0)
      {
        return 0;
      };
       ...
       * @return QgsFeature
       */
      virtual QgsFeature * getFirstFeature(bool fetchAttributes = false, size_t dataSourceLayerNum = 0) = 0;

      /** 
       * Get the next feature resutling from a select operation
       * @return QgsFeature
       */
      virtual QgsFeature * getNextFeature(bool fetchAttributes = false, size_t dataSourceLayerNum = 0) = 0;
...
//    virtual QgsFeature* getNextFeature(std::list<int> const & attlist) = 0;
      ...
      virtual QgsFeature* getNextFeature(std::list<int> const & attlist, int featureQueueSize = 1,size_t dataSourceLayerNum = 0) { return 0; }
      ...
      virtual bool getNextFeature(QgsFeature &feature, bool fetchAttributes = false,size_t dataSourceLayerNum = 0) = 0;

      /** Get feature type.
       * Gets the feature type as defined in WKBTYPE (qgis.h).
       * @return int representing the feature type
       */
      virtual int geometryType(size_t dataSourceLayerNum = 0) const = 0;
       ...
       */
      virtual long featureCount(size_t dataSourceLayerNum = 0) const = 0;

      /**
     * Get the attributes associated with a feature
     * TODO: Get rid of "row" and set up provider-internal caching instead
     */
    virtual void getFeatureAttributes(int oid, int& row, QgsFeature *f, size_t dataSourceLayerNum = 0) {};
    
    /**
       * Number of attribute fields for a feature in the layer
       */
      virtual int fieldCount(size_t dataSourceLayerNum = 0) const = 0;

      /**
       * Return a list of field names for this layer
       * @return vector of field names
       */
      virtual std::vector<QgsField> const & fields(size_t dataSourceLayerNum = 0) const = 0;
       ...
       * function body.
       */
      virtual void reset(size_t dataSourceLayerNum = 0) = 0;

      /**Returns the minimum value of an attributs
        @param position the number of the attribute*/
      virtual QString minValue(int position, size_t dataSourceLayerNum = 0) = 0;

      /**Returns the maximum value of an attributs
        @param position the number of the attribute*/
      virtual QString maxValue(int position, size_t dataSourceLayerNum = 0) = 0;

      /**Adds a list of features
        @return true in case of success and false in case of failure*/
      virtual bool addFeatures(std::list<QgsFeature*> const flist, size_t dataSourceLayerNum = 0);

      /**Deletes a feature
        @param id list containing feature ids to delete
        @return true in case of success and false in case of failure*/
      virtual bool deleteFeatures(std::list<int> const & id, size_t dataSourceLayerNum = 0);

      /**Adds new attributes
        @param name map with attribute name as key and type as value
        @param dataSourceLayerNum layer number within data source with zero is first layer
        @return true in case of success and false in case of failure*/
      virtual bool addAttributes(std::map<QString,QString> const & name, size_t dataSourceLayerNum = 0);

      /**Deletes existing attributes
        @param names of the attributes to delete
        @return true in case of success and false in case of failure*/
      virtual bool deleteAttributes(std::set<QString> const & name, size_t dataSourceLayerNum = 0);

      /**Changes attribute values of existing features
        @param attr_map a map containing the new attributes. The integer is the feature id,
        the first QString is the attribute name and the second one is the new attribute value
        @return true in case of success and false in case of failure*/
      virtual bool changeAttributeValues(std::map<int,std::map<QString,QString> > const & attr_map, size_t dataSourceLayerNum = 0);

      /**Returns the default value for attribute @c attr for feature @c f. */
      virtual QString getDefaultValue(const QString & attr, QgsFeature* f, size_t dataSourceLayerNum = 0);
      ...
      /**
       ...
       @return               true in case of success and false in case of failure
     */
    virtual bool changeGeometryValues(std::map<int, QgsGeometry> & geometry_map, size_t dataSourceLayerNum = 0);
    ...
    /**
       ...
       */
    //virtual std::vector<QgsFeature>& identify(QgsRect *rect, size_t dataSourceLayerNum = 0) = 0;
    virtual void identify(QgsRect *rect, size_t dataSourceLayerNum = 0) = 0;
